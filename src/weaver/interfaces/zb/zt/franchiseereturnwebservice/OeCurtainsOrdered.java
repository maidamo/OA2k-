...
public class OeCurtainsOrdered  extends weaver.interfaces.zb.zt.franchiseereturnwebservice.BaseDTO  implements java.io.Serializable {
    private java.lang.String category;

    private weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsConfigure[] configList;

    private weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsType[] configTypeList;
    ...
    public OeCurtainsOrdered(
           ...
           weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsConfigure[] configList,
           weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsType[] configTypeList,
     ...
     * @return configList
     */
    public weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsConfigure[] getConfigList() {
        return configList;
    }
     ...
     * @param configList
     */
    public void setConfigList(weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsConfigure[] configList) {
        this.configList = configList;
    }

    public weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsConfigure getConfigList(int i) {
        return this.configList[i];
    }

    public void setConfigList(int i, weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsConfigure _value) {
     ...
     */
    public weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsType[] getConfigTypeList() {
        return configTypeList;
    }
     ...
     */
    public void setConfigTypeList(weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsType[] configTypeList) {
        this.configTypeList = configTypeList;
    }

    public weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsType getConfigTypeList(int i) {
        return this.configTypeList[i];
    }

    public void setConfigTypeList(int i, weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsType _value) {
