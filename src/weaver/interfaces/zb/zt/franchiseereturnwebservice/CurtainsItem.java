...
public class CurtainsItem  implements java.io.Serializable {
    private weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsType[] curtainsType;
    ...
    private weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsItemRel[] itemRelation;
    ...
    public CurtainsItem(
           weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsType[] curtainsType,
           ...
           weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsItemRel[] itemRelation,
     ...
     * @return curtainsType
     */
    public weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsType[] getCurtainsType() {
        return curtainsType;
    }
     ...
     * @param curtainsType
     */
    public void setCurtainsType(weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsType[] curtainsType) {
        this.curtainsType = curtainsType;
    }

    public weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsType getCurtainsType(int i) {
        return this.curtainsType[i];
    }

    public void setCurtainsType(int i, weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsType _value) {
     ...
     * @return itemRelation
     */
    public weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsItemRel[] getItemRelation() {
        return itemRelation;
    }
     ...
     * @param itemRelation
     */
    public void setItemRelation(weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsItemRel[] itemRelation) {
        this.itemRelation = itemRelation;
    }

    public weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsItemRel getItemRelation(int i) {
        return this.itemRelation[i];
    }

    public void setItemRelation(int i, weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsItemRel _value) {
