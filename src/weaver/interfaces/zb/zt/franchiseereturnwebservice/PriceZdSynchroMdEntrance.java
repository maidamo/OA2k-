...
public class PriceZdSynchroMdEntrance  implements java.io.Serializable {
    private weaver.interfaces.zb.zt.franchiseereturnwebservice.PriceAddInter[] elements;

    public PriceZdSynchroMdEntrance() {
    }

    public PriceZdSynchroMdEntrance(
           weaver.interfaces.zb.zt.franchiseereturnwebservice.PriceAddInter[] elements) {
     ...
     * @return elements
     */
    public weaver.interfaces.zb.zt.franchiseereturnwebservice.PriceAddInter[] getElements() {
        return elements;
    }
     ...
     * @param elements
     */
    public void setElements(weaver.interfaces.zb.zt.franchiseereturnwebservice.PriceAddInter[] elements) {
        this.elements = elements;
    }
