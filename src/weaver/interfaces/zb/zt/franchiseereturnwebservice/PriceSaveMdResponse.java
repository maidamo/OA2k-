...
public class PriceSaveMdResponse  implements java.io.Serializable {
    private weaver.interfaces.zb.zt.franchiseereturnwebservice.InterfaceResult result;

    public PriceSaveMdResponse() {
    }
    ...
    /**
     * Gets the result value for this PriceSaveMdResponse.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this PriceSaveMdResponse.
     * 
     * @param result
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PriceSaveMdResponse)) return false;
        PriceSaveMdResponse other = (PriceSaveMdResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PriceSaveMdResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservice.itf.core.crm/", "priceSaveMdResponse"));
