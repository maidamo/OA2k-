...
public class OrderDeliveryStateMdEntrance  extends weaver.interfaces.zb.zt.franchiseereturnwebservice.UnPsBaseEntrance  implements java.io.Serializable {
    private weaver.interfaces.zb.zt.franchiseereturnwebservice.OeOrderCompleteDate[] elements;
    ...
    public OrderDeliveryStateMdEntrance(
           ...
           weaver.interfaces.zb.zt.franchiseereturnwebservice.OeOrderCompleteDate[] elements) {
        super(
            loginName,
            password);
     ...
     * @return elements
     */
    public weaver.interfaces.zb.zt.franchiseereturnwebservice.OeOrderCompleteDate[] getElements() {
        return elements;
    }
     ...
     * @param elements
     */
    public void setElements(weaver.interfaces.zb.zt.franchiseereturnwebservice.OeOrderCompleteDate[] elements) {
        this.elements = elements;
    }
