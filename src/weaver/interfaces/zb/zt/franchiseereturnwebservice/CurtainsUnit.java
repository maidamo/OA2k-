...
public class CurtainsUnit  implements java.io.Serializable {
    private weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsLine[] lineList;
    ...
    public CurtainsUnit(
           weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsLine[] lineList,
     ...
     * @return lineList
     */
    public weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsLine[] getLineList() {
        return lineList;
    }
     ...
     * @param lineList
     */
    public void setLineList(weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsLine[] lineList) {
        this.lineList = lineList;
    }

    public weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsLine getLineList(int i) {
        return this.lineList[i];
    }

    public void setLineList(int i, weaver.interfaces.zb.zt.franchiseereturnwebservice.CurtainsLine _value) {
