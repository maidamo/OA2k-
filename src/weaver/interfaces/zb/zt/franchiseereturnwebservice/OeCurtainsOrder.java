...
public class OeCurtainsOrder  extends weaver.interfaces.zb.zt.franchiseereturnwebservice.BaseDTO  implements java.io.Serializable {
    ...
    private weaver.interfaces.zb.zt.franchiseereturnwebservice.OrderHeaders[] headersList;
    ...
    private weaver.interfaces.zb.zt.franchiseereturnwebservice.OrderFile[] lineAmountSum;
    ...
    private weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsOrdered[] partsList;
    ...
    public OeCurtainsOrder(
           ...
           weaver.interfaces.zb.zt.franchiseereturnwebservice.OrderHeaders[] headersList,
           java.lang.Long id,
           java.lang.String isDelete,
           java.lang.String isFreight,
           java.lang.String isPay,
           weaver.interfaces.zb.zt.franchiseereturnwebservice.OrderFile[] lineAmountSum,
           java.lang.String mainOrderCode,
           java.lang.String orderDivideNumber,
           java.lang.Long orderId,
           weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsOrdered[] partsList,
     ...
     * @return headersList
     */
    public weaver.interfaces.zb.zt.franchiseereturnwebservice.OrderHeaders[] getHeadersList() {
        return headersList;
    }
     ...
     * @param headersList
     */
    public void setHeadersList(weaver.interfaces.zb.zt.franchiseereturnwebservice.OrderHeaders[] headersList) {
        this.headersList = headersList;
    }

    public weaver.interfaces.zb.zt.franchiseereturnwebservice.OrderHeaders getHeadersList(int i) {
        return this.headersList[i];
    }

    public void setHeadersList(int i, weaver.interfaces.zb.zt.franchiseereturnwebservice.OrderHeaders _value) {
     ...
     */
    public weaver.interfaces.zb.zt.franchiseereturnwebservice.OrderFile[] getLineAmountSum() {
        return lineAmountSum;
    }
     ...
     * @param lineAmountSum
     */
    public void setLineAmountSum(weaver.interfaces.zb.zt.franchiseereturnwebservice.OrderFile[] lineAmountSum) {
        this.lineAmountSum = lineAmountSum;
    }

    public weaver.interfaces.zb.zt.franchiseereturnwebservice.OrderFile getLineAmountSum(int i) {
        return this.lineAmountSum[i];
    }

    public void setLineAmountSum(int i, weaver.interfaces.zb.zt.franchiseereturnwebservice.OrderFile _value) {
     ...
     * @return partsList
     */
    public weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsOrdered[] getPartsList() {
        return partsList;
    }
     ...
     * @param partsList
     */
    public void setPartsList(weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsOrdered[] partsList) {
        this.partsList = partsList;
    }

    public weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsOrdered getPartsList(int i) {
        return this.partsList[i];
    }

    public void setPartsList(int i, weaver.interfaces.zb.zt.franchiseereturnwebservice.OeCurtainsOrdered _value) {
