...
public class OrderAdd  implements java.io.Serializable {
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.OrderLines[] orderLines;
    ...
    public OrderAdd(
           ...
           weaver.interfaces.zb.zt.storereturnwebservice.OrderLines[] orderLines,
     ...
     * @return orderLines
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OrderLines[] getOrderLines() {
        return orderLines;
    }
     ...
     * @param orderLines
     */
    public void setOrderLines(weaver.interfaces.zb.zt.storereturnwebservice.OrderLines[] orderLines) {
        this.orderLines = orderLines;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.OrderLines getOrderLines(int i) {
        return this.orderLines[i];
    }

    public void setOrderLines(int i, weaver.interfaces.zb.zt.storereturnwebservice.OrderLines _value) {
