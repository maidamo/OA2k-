...
public class AccountZdSynchroMdEntrance  implements java.io.Serializable {
    private weaver.interfaces.zb.zt.storereturnwebservice.AccountResponse[] elements;

    public AccountZdSynchroMdEntrance() {
    }

    public AccountZdSynchroMdEntrance(
           weaver.interfaces.zb.zt.storereturnwebservice.AccountResponse[] elements) {
     ...
     * @return elements
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.AccountResponse[] getElements() {
        return elements;
    }
     ...
     * @param elements
     */
    public void setElements(weaver.interfaces.zb.zt.storereturnwebservice.AccountResponse[] elements) {
        this.elements = elements;
    }
