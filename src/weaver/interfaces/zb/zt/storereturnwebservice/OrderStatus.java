...
public class OrderStatus  implements java.io.Serializable {
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.OrderStatusRelation[] orderList;

    private java.lang.String orderProgress;

    private weaver.interfaces.zb.zt.storereturnwebservice.OrderStatusReject[] rejectList;
    ...
    public OrderStatus(
           ...
           weaver.interfaces.zb.zt.storereturnwebservice.OrderStatusRelation[] orderList,
           java.lang.String orderProgress,
           weaver.interfaces.zb.zt.storereturnwebservice.OrderStatusReject[] rejectList,
     ...
     * @return orderList
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OrderStatusRelation[] getOrderList() {
        return orderList;
    }
     ...
     * @param orderList
     */
    public void setOrderList(weaver.interfaces.zb.zt.storereturnwebservice.OrderStatusRelation[] orderList) {
        this.orderList = orderList;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.OrderStatusRelation getOrderList(int i) {
        return this.orderList[i];
    }

    public void setOrderList(int i, weaver.interfaces.zb.zt.storereturnwebservice.OrderStatusRelation _value) {
     ...
     * @return rejectList
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OrderStatusReject[] getRejectList() {
        return rejectList;
    }
     ...
     * @param rejectList
     */
    public void setRejectList(weaver.interfaces.zb.zt.storereturnwebservice.OrderStatusReject[] rejectList) {
        this.rejectList = rejectList;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.OrderStatusReject getRejectList(int i) {
        return this.rejectList[i];
    }

    public void setRejectList(int i, weaver.interfaces.zb.zt.storereturnwebservice.OrderStatusReject _value) {
