...
public class MessageBo  implements java.io.Serializable {
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.OeNotice info;
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.OeNotice[] noticeList;

    private java.lang.String orderHeaderId;

    private java.lang.Long orderId;

    private weaver.interfaces.zb.zt.storereturnwebservice.OrderHeaders[] orderList;

    private weaver.interfaces.zb.zt.storereturnwebservice.OrderProgress[] orderProgressesList;

    private java.lang.String quoteIntId;

    private weaver.interfaces.zb.zt.storereturnwebservice.ResponseAccount[] responseAccounts;

    private weaver.interfaces.zb.zt.storereturnwebservice.ResponseSites[] responseSites;
    ...
    public MessageBo(
           ...
           java.lang.String id,
           weaver.interfaces.zb.zt.storereturnwebservice.OeNotice info,
           java.lang.String interfaceId,
           java.lang.String item_code,
           java.lang.String keyMessage,
           weaver.interfaces.zb.zt.storereturnwebservice.OeNotice[] noticeList,
           java.lang.String orderHeaderId,
           java.lang.Long orderId,
           weaver.interfaces.zb.zt.storereturnwebservice.OrderHeaders[] orderList,
           weaver.interfaces.zb.zt.storereturnwebservice.OrderProgress[] orderProgressesList,
           java.lang.String quoteIntId,
           weaver.interfaces.zb.zt.storereturnwebservice.ResponseAccount[] responseAccounts,
           weaver.interfaces.zb.zt.storereturnwebservice.ResponseSites[] responseSites,
     ...
     * @return info
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OeNotice getInfo() {
        return info;
    }
     ...
     * @param info
     */
    public void setInfo(weaver.interfaces.zb.zt.storereturnwebservice.OeNotice info) {
        this.info = info;
    }
     ...
     * @return noticeList
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OeNotice[] getNoticeList() {
        return noticeList;
    }
     ...
     * @param noticeList
     */
    public void setNoticeList(weaver.interfaces.zb.zt.storereturnwebservice.OeNotice[] noticeList) {
        this.noticeList = noticeList;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.OeNotice getNoticeList(int i) {
        return this.noticeList[i];
    }

    public void setNoticeList(int i, weaver.interfaces.zb.zt.storereturnwebservice.OeNotice _value) {
     ...
     * @return orderList
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OrderHeaders[] getOrderList() {
        return orderList;
    }
     ...
     * @param orderList
     */
    public void setOrderList(weaver.interfaces.zb.zt.storereturnwebservice.OrderHeaders[] orderList) {
        this.orderList = orderList;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.OrderHeaders getOrderList(int i) {
        return this.orderList[i];
    }

    public void setOrderList(int i, weaver.interfaces.zb.zt.storereturnwebservice.OrderHeaders _value) {
     ...
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OrderProgress[] getOrderProgressesList() {
        return orderProgressesList;
    }
     ...
     */
    public void setOrderProgressesList(weaver.interfaces.zb.zt.storereturnwebservice.OrderProgress[] orderProgressesList) {
        this.orderProgressesList = orderProgressesList;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.OrderProgress getOrderProgressesList(int i) {
        return this.orderProgressesList[i];
    }

    public void setOrderProgressesList(int i, weaver.interfaces.zb.zt.storereturnwebservice.OrderProgress _value) {
     ...
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.ResponseAccount[] getResponseAccounts() {
        return responseAccounts;
    }
     ...
     */
    public void setResponseAccounts(weaver.interfaces.zb.zt.storereturnwebservice.ResponseAccount[] responseAccounts) {
        this.responseAccounts = responseAccounts;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.ResponseAccount getResponseAccounts(int i) {
        return this.responseAccounts[i];
    }

    public void setResponseAccounts(int i, weaver.interfaces.zb.zt.storereturnwebservice.ResponseAccount _value) {
     ...
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.ResponseSites[] getResponseSites() {
        return responseSites;
    }
     ...
     * @param responseSites
     */
    public void setResponseSites(weaver.interfaces.zb.zt.storereturnwebservice.ResponseSites[] responseSites) {
        this.responseSites = responseSites;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.ResponseSites getResponseSites(int i) {
        return this.responseSites[i];
    }

    public void setResponseSites(int i, weaver.interfaces.zb.zt.storereturnwebservice.ResponseSites _value) {
