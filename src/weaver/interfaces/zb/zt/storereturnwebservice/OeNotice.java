...
public class OeNotice  extends weaver.interfaces.zb.zt.storereturnwebservice.BaseDTO  implements java.io.Serializable {
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.OrderFile[] fileList;
    ...
    public OeNotice(
           ...
           weaver.interfaces.zb.zt.storereturnwebservice.OrderFile[] fileList,
     ...
     * @return fileList
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OrderFile[] getFileList() {
        return fileList;
    }
     ...
     * @param fileList
     */
    public void setFileList(weaver.interfaces.zb.zt.storereturnwebservice.OrderFile[] fileList) {
        this.fileList = fileList;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.OrderFile getFileList(int i) {
        return this.fileList[i];
    }

    public void setFileList(int i, weaver.interfaces.zb.zt.storereturnwebservice.OrderFile _value) {
