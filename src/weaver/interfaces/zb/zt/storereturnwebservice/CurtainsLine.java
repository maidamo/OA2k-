...
public class CurtainsLine  implements java.io.Serializable {
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.MaterDetail[] materList;
    ...
    public CurtainsLine(
           ...
           weaver.interfaces.zb.zt.storereturnwebservice.MaterDetail[] materList,
     ...
     * @return materList
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.MaterDetail[] getMaterList() {
        return materList;
    }
     ...
     * @param materList
     */
    public void setMaterList(weaver.interfaces.zb.zt.storereturnwebservice.MaterDetail[] materList) {
        this.materList = materList;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.MaterDetail getMaterList(int i) {
        return this.materList[i];
    }

    public void setMaterList(int i, weaver.interfaces.zb.zt.storereturnwebservice.MaterDetail _value) {
