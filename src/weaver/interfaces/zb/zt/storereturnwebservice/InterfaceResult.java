...
public class InterfaceResult  implements java.io.Serializable {
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.MessageBo[] rows;
    ...
    public InterfaceResult(
           ...
           weaver.interfaces.zb.zt.storereturnwebservice.MessageBo[] rows) {
           this.code = code;
           this.flag = flag;
     ...
     * @return rows
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.MessageBo[] getRows() {
        return rows;
    }
     ...
     * @param rows
     */
    public void setRows(weaver.interfaces.zb.zt.storereturnwebservice.MessageBo[] rows) {
        this.rows = rows;
    }
