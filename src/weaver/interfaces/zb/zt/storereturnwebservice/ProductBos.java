...
public class ProductBos  implements java.io.Serializable {
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.ProductAttrs[] productAttrsList;
    ...
    public ProductBos(
           ...
           weaver.interfaces.zb.zt.storereturnwebservice.ProductAttrs[] productAttrsList,
     ...
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.ProductAttrs[] getProductAttrsList() {
        return productAttrsList;
    }
     ...
     */
    public void setProductAttrsList(weaver.interfaces.zb.zt.storereturnwebservice.ProductAttrs[] productAttrsList) {
        this.productAttrsList = productAttrsList;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.ProductAttrs getProductAttrsList(int i) {
        return this.productAttrsList[i];
    }

    public void setProductAttrsList(int i, weaver.interfaces.zb.zt.storereturnwebservice.ProductAttrs _value) {
