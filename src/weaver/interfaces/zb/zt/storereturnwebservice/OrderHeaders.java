...
public class OrderHeaders  extends weaver.interfaces.zb.zt.storereturnwebservice.BaseDTO  implements java.io.Serializable {
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.OrderApplication[] applicationList;
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.OrderHeadersMonthMapEntry[] monthMap;
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.OeCurtainsOrder oeCurtainsOrder;
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.OrderDivide[] orderDivideList;

    private weaver.interfaces.zb.zt.storereturnwebservice.OeOrderDoor[] orderDoorList;
    ...
    public OrderHeaders(
           ...
           weaver.interfaces.zb.zt.storereturnwebservice.OrderApplication[] applicationList,
           ...
           weaver.interfaces.zb.zt.storereturnwebservice.OrderHeadersMonthMapEntry[] monthMap,
           java.lang.String monthSum,
           java.util.Calendar needByDate,
           java.util.Calendar needInstallDate,
           java.lang.String netChannelName,
           weaver.interfaces.zb.zt.storereturnwebservice.OeCurtainsOrder oeCurtainsOrder,
           java.lang.String orderCoProgress,
           java.util.Calendar orderDate,
           java.lang.String orderDateEnd,
           java.lang.String orderDateStart,
           weaver.interfaces.zb.zt.storereturnwebservice.OrderDivide[] orderDivideList,
           weaver.interfaces.zb.zt.storereturnwebservice.OeOrderDoor[] orderDoorList,
     ...
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OrderApplication[] getApplicationList() {
        return applicationList;
    }
     ...
     */
    public void setApplicationList(weaver.interfaces.zb.zt.storereturnwebservice.OrderApplication[] applicationList) {
        this.applicationList = applicationList;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.OrderApplication getApplicationList(int i) {
        return this.applicationList[i];
    }

    public void setApplicationList(int i, weaver.interfaces.zb.zt.storereturnwebservice.OrderApplication _value) {
     ...
     * @return monthMap
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OrderHeadersMonthMapEntry[] getMonthMap() {
        return monthMap;
    }
     ...
     * @param monthMap
     */
    public void setMonthMap(weaver.interfaces.zb.zt.storereturnwebservice.OrderHeadersMonthMapEntry[] monthMap) {
        this.monthMap = monthMap;
    }
     ...
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OeCurtainsOrder getOeCurtainsOrder() {
        return oeCurtainsOrder;
    }
     ...
     */
    public void setOeCurtainsOrder(weaver.interfaces.zb.zt.storereturnwebservice.OeCurtainsOrder oeCurtainsOrder) {
        this.oeCurtainsOrder = oeCurtainsOrder;
    }
     ...
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OrderDivide[] getOrderDivideList() {
        return orderDivideList;
    }
     ...
     */
    public void setOrderDivideList(weaver.interfaces.zb.zt.storereturnwebservice.OrderDivide[] orderDivideList) {
        this.orderDivideList = orderDivideList;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.OrderDivide getOrderDivideList(int i) {
        return this.orderDivideList[i];
    }

    public void setOrderDivideList(int i, weaver.interfaces.zb.zt.storereturnwebservice.OrderDivide _value) {
     ...
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OeOrderDoor[] getOrderDoorList() {
        return orderDoorList;
    }
     ...
     * @param orderDoorList
     */
    public void setOrderDoorList(weaver.interfaces.zb.zt.storereturnwebservice.OeOrderDoor[] orderDoorList) {
        this.orderDoorList = orderDoorList;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.OeOrderDoor getOrderDoorList(int i) {
        return this.orderDoorList[i];
    }

    public void setOrderDoorList(int i, weaver.interfaces.zb.zt.storereturnwebservice.OeOrderDoor _value) {
