...
public class OrderDivide  extends weaver.interfaces.zb.zt.storereturnwebservice.BaseDTO  implements java.io.Serializable {
    ...
    private weaver.interfaces.zb.zt.storereturnwebservice.OrderDividePrice[] orderDividePriceList;
    ...
    public OrderDivide(
           ...
           weaver.interfaces.zb.zt.storereturnwebservice.OrderDividePrice[] orderDividePriceList,
     ...
     */
    public weaver.interfaces.zb.zt.storereturnwebservice.OrderDividePrice[] getOrderDividePriceList() {
        return orderDividePriceList;
    }
     ...
     */
    public void setOrderDividePriceList(weaver.interfaces.zb.zt.storereturnwebservice.OrderDividePrice[] orderDividePriceList) {
        this.orderDividePriceList = orderDividePriceList;
    }

    public weaver.interfaces.zb.zt.storereturnwebservice.OrderDividePrice getOrderDividePriceList(int i) {
        return this.orderDividePriceList[i];
    }

    public void setOrderDividePriceList(int i, weaver.interfaces.zb.zt.storereturnwebservice.OrderDividePrice _value) {
